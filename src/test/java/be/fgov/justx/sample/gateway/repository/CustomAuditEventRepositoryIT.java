package be.fgov.justx.sample.gateway.repository;

import be.fgov.justx.sample.gateway.JHipsterApiGatewayApp;
import be.fgov.justx.sample.gateway.config.Constants;
import be.fgov.justx.sample.gateway.config.audit.AuditEventConverter;
import be.fgov.justx.sample.gateway.domain.PersistentAuditEvent;
...
import static be.fgov.justx.sample.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
