package be.fgov.justx.sample.gateway.config.timezone;

import be.fgov.justx.sample.gateway.JHipsterApiGatewayApp;
import be.fgov.justx.sample.gateway.repository.timezone.DateTimeWrapper;
import be.fgov.justx.sample.gateway.repository.timezone.DateTimeWrapperRepository;
